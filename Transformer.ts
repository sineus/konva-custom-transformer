import {Util, Collection} from "konva/types/Util";
import {Factory} from "konva/types/Factory";
import {GetSet, IRect} from "konva/types/types";
import {Node} from "konva/types/Node";
import {Rect} from "konva/types/shapes/Rect";
import {Shape} from "konva/types/Shape";
import {Group} from "konva/types/Group";
import {ContainerConfig} from "konva/types/Container";
import {getNumberValidator} from "konva/types/Validators";
import {_registerNode, Konva} from "konva/types/Global";
...
export class CustomTransformer extends Group {
  _node: Node;
...
CustomTransformer.prototype.className = 'CustomTransformer';
_registerNode(CustomTransformer);
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'resizeEnabled', true);
/**
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'anchorSize', 10, getNumberValidator());
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'rotateEnabled', true);
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'rotationSnaps', []);
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'borderEnabled', true);
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'anchorStroke', 'rgb(0, 161, 255)');
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'anchorFill', 'white');
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'borderStroke', 'rgb(0, 161, 255)');
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'borderDash');
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'keepRatio', true);
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'centeredScaling', false);
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'ignoreStroke', false);
 ...
 */
Factory.addGetterSetter(CustomTransformer, 'padding', 0, getNumberValidator());
...
Factory.addGetterSetter(CustomTransformer, 'node');
 ...
 * });
 */
Factory.addGetterSetter(CustomTransformer, 'boundBoxFunc');

Factory.backCompat(CustomTransformer, {
  lineEnabled: 'borderEnabled',
  rotateHandlerOffset: 'rotateAnchorOffset',
  enabledHandlers: 'enabledAnchors'
});

Collection.mapMethods(CustomTransformer);